...
public class ClientHelper {
    ...
    public ClientHelper(Prefix source, ActorSystem system, ILocationService locationService) throws Exception {
    ...
    private Connection.AkkaConnection assemblyConnection = new Connection.AkkaConnection(new ComponentId("SamplepkAssembly", Assembly));
