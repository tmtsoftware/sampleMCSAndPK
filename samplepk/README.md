...
* samplepkAssembly - an assembly that talks to the samplepk HCD
* samplepk-hcd - an HCD that talks to the samplepk hardware
* samplepkDeploy - for starting/deploying HCDs and assemblies
...
## Building the HCD and Assembly Applications
 ...
 - Run `sbt samplepkDeploy/universal:packageBin`, this will create self contained zip in `samplepkDeploy/target/universal` directory
...
```
./target/universal/stage/bin/samplepk-container-cmd-app --standalone --local ./src/main/resources/SampleHcdStandalone.conf
```

* Start the HCD and assembly in a container using the Java implementations:

```
./target/universal/stage/bin/samplepk-container-cmd-app --local ./src/main/resources/JSampleContainer.conf
```

* Or the Scala versions:

```
./target/universal/stage/bin/samplepk-container-cmd-app --local ./src/main/resources/SampleContainer.conf
```
