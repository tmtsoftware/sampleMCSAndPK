...
public class PKClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClientHelper pkClient   = new ClientHelper(new Prefix("tcs.pk"), system, locationService);
        Optional<ObsId> maybeObsId          = Optional.empty();
        String hostName                = InetAddress.getLocalHost().getHostName();
        JLoggingSystemFactory.start("PKClient", "0.1", hostName, system);
